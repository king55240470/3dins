...
static constexpr auto qt_meta_stringdata_CLASSReportWidgetENDCLASS = QtMocHelpers::stringData(
    "ReportWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSReportWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSReportWidgetENDCLASS_t qt_meta_stringdata_CLASSReportWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12)   // "ReportWidget"
    },
    "ReportWidget"
};
