...
Q_CONSTINIT static const qt_meta_stringdata_CLASSElementListWidgetENDCLASS_t qt_meta_stringdata_CLASSElementListWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(18, 12),  // "itemSelected"
        QT_MOC_LITERAL(31, 0),  // ""
...
void ElementListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ElementListWidget::*)(int );
            if (_t _q_method = &ElementListWidget::itemSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ElementListWidget::itemSelected(int _t1)
{
